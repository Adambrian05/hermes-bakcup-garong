# #176: Treating of BLOCK_TIME as permanent will cause serious economic flaws in the oracle when block times change
Labels: ['bug', '2 (Med Risk)', 'primary issue', 'satisfactory', 'selected for report', 'sponsor confirmed', 'M-08']
Accepted: True
