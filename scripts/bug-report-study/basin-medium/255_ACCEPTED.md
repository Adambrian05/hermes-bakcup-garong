# #255: Long term denial of service due to lack of fees in Well
Labels: ['bug', '2 (Med Risk)', 'downgraded by judge', 'primary issue', 'selected for report', 'sponsor disputed', 'M-04']
Accepted: True
