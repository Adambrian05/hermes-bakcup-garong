# #263: Memory corruption in getBytes32FromBytes() can likely lead to loss of funds
Labels: ['bug', '2 (Med Risk)', 'disagree with severity', 'downgraded by judge', 'judge review requested', 'primary issue', 'satisfactory', 'selected for report', 'sponsor acknowledged', 'M-01']
Accepted: True
