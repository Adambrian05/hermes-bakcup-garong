# #55: Single hardcoded cap used for multiple tokens in a pump causing some assets to be more stale, while having no effects on other stable assets
Labels: ['bug', '2 (Med Risk)', 'disagree with severity', 'primary issue', 'satisfactory', 'selected for report', 'sponsor acknowledged', 'edited-by-warden', 'M-12']
Accepted: True
