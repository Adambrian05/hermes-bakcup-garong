# #82: addLiquidity Sandwich Attack for unbalanced token deposits
Labels: ['bug', '2 (Med Risk)', 'downgraded by judge', 'primary issue', 'satisfactory', 'selected for report', 'sponsor disputed', 'edited-by-warden', 'M-11']
Accepted: True
