# #259: Due to bit-shifting errors, reserve amounts in the pump will be corrupted, resulting in wrong oracle values
Labels: ['bug', '2 (Med Risk)', 'disagree with severity', 'downgraded by judge', 'primary issue', 'satisfactory', 'selected for report', 'sponsor confirmed', 'M-03']
Accepted: True
