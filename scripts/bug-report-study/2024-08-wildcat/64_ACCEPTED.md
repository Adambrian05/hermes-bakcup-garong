# #64: User could withdraw more than supposed to, forcing last user withdraw to fail
Labels: ['bug', '3 (High Risk)', 'primary issue', 'satisfactory', 'selected for report', 'sponsor confirmed', 'sufficient quality report', 'edited-by-warden', ':robot:_14_group', 'H-01']
Accepted: True
