# #203: Charging more Credit than what it should be really charged to CreditSellers when Selling Credit with a market order for a specific amount of cash.
Labels: ['bug', '3 (High Risk)', 'satisfactory', 'sufficient quality report', 'edited-by-warden', ':robot:_17_group', 'duplicate-288']
Accepted: False
