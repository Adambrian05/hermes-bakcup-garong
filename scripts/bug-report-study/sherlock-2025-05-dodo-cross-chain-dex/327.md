...
# Anyone can claim refunds in `GatewayTransferNative.sol`
...
1. The cross-chain transaction must revert
2. The refund wallet address must be a solana address.
...
1. Alice initiates a cross chain transaction of transferring 100 usdt.
