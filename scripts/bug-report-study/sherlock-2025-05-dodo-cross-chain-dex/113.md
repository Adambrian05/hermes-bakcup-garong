...
In `GatewayTransferNative.sol` the `claimRefund` function sets

https://github.com/sherlock-audit/2025-05-dodo-cross-chain-dex/blob/main/omni-chain-contracts/contracts/GatewayTransferNative.sol#L664-L668
