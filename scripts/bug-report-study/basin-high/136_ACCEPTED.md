# #136: Pumps are not updated in the shift() and sync() functions, allowing oracle manipulation
Labels: ['bug', '3 (High Risk)', 'primary issue', 'selected for report', 'sponsor confirmed', 'H-01']
Accepted: True
