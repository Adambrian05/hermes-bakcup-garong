# #26: Unlimited Nibi could be minted because evm and bank balance are not synced when staking
Labels: ['bug', '3 (High Risk)', 'primary issue', 'satisfactory', 'selected for report', 'sponsor confirmed', 'sufficient quality report', ':robot:_primary', 'H-03']
Accepted: True
