# #401: `AuraVault::claim` reward calculation does not deduct fees from reward amount, causing DoS or extra rewards lost
Labels: ['bug', '3 (High Risk)', 'primary issue', 'satisfactory', 'selected for report', 'sufficient quality report', ':robot:_primary', ':robot:_120_group', 'H-01']
Accepted: True
